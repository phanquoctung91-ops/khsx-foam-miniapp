CREATE OR REPLACE FUNCTION public.khsx_apply_stage_progress_v2(p_operation_id uuid, p_order_id text, p_work_date date, p_stage khsx_stage, p_quantity integer, p_kpi_team khsx_unit DEFAULT NULL::khsx_unit, p_worker_id text DEFAULT NULL::text, p_device_id text DEFAULT ''::text)
